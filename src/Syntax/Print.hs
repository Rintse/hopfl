...
instance Print Syntax.Abs.Exp where
  prt i e = case e of
    Syntax.Abs.Var id -> prPrec i 12 (concatD [prt 0 id])
    Syntax.Abs.Val d -> prPrec i 12 (concatD [prt 0 d])
    Syntax.Abs.BVal bconst -> prPrec i 12 (concatD [prt 0 bconst])
    Syntax.Abs.Next exp -> prPrec i 11 (concatD [doc (showString "next"), prt 12 exp])
    Syntax.Abs.Prev environment exp -> prPrec i 11 (concatD [doc (showString "prev"), doc (showString "{"), prt 0 environment, doc (showString "}"), doc (showString "."), prt 12 exp])
    Syntax.Abs.PrevE exp -> prPrec i 11 (concatD [doc (showString "prev"), prt 12 exp])
    Syntax.Abs.PrevI exp -> prPrec i 11 (concatD [doc (showString "prevI"), prt 12 exp])
    Syntax.Abs.Box environment exp -> prPrec i 11 (concatD [doc (showString "box"), doc (showString "{"), prt 0 environment, doc (showString "}"), doc (showString "."), prt 11 exp])
    Syntax.Abs.BoxI exp -> prPrec i 11 (concatD [doc (showString "boxI"), prt 12 exp])
    Syntax.Abs.Unbox exp -> prPrec i 11 (concatD [doc (showString "unbox"), prt 12 exp])
    Syntax.Abs.In exp -> prPrec i 11 (concatD [doc (showString "in"), prt 12 exp])
    Syntax.Abs.Out exp -> prPrec i 11 (concatD [doc (showString "out"), prt 12 exp])
    Syntax.Abs.Fst exp -> prPrec i 11 (concatD [doc (showString "fst"), prt 12 exp])
    Syntax.Abs.Snd exp -> prPrec i 11 (concatD [doc (showString "snd"), prt 12 exp])
    Syntax.Abs.InL exp -> prPrec i 11 (concatD [doc (showString "inL"), prt 12 exp])
    Syntax.Abs.InR exp -> prPrec i 11 (concatD [doc (showString "inR"), prt 12 exp])
    Syntax.Abs.App exp1 exp2 -> prPrec i 10 (concatD [prt 10 exp1, prt 11 exp2])
    Syntax.Abs.LApp exp1 tlapp exp2 -> prPrec i 10 (concatD [prt 10 exp1, prt 0 tlapp, prt 11 exp2])
    Syntax.Abs.Pow exp1 exp2 -> prPrec i 9 (concatD [prt 9 exp1, doc (showString "^"), prt 10 exp2])
