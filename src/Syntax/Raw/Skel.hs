...
transExp x = case x of
  ...
  Syntax.Raw.Abs.ECoList colst -> failure x
  ...
  Syntax.Raw.Abs.FColist exp -> failure x
...
transCoLst :: Syntax.Raw.Abs.CoLst -> Result
transCoLst x = case x of
  Syntax.Raw.Abs.CoList els -> failure x
